  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hola, soy el asistente de UPTC Energy. Puedo ayudarte con informacion sobre consumo energetico, recomendaciones de ahorro y analisis de sostenibilidad. ¿En que puedo ayudarte?',
      timestamp: new Date(),
    },
  ]);
